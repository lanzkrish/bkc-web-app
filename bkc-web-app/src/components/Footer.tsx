  ...
  return (
    <footer className="bg-surface-dark text-text-light py-20">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <ul className="space-y-3 font-body-md text-text-light/70">
              ...
              <li>
                <a
                  href="https://wa.me/918339888901?text=I%20want%20to%20know%20about%20job%20opportunities"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-gold transition-colors flex items-center gap-1.5"
                >
                  Careers
                  <span className="text-[10px] uppercase font-bold tracking-wider px-1.5 py-0.2 rounded bg-primary/20 text-gold border border-gold/30">Hiring</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 text-text-light/70 font-body-md">
            ...
            <p className="flex items-center gap-2">
              ...
              <a href="tel:+918339888901" className="hover:text-gold transition-colors">083398 88901</a>
            </p>
            <p className="flex items-center gap-2">
              <span className="material-symbols-outlined text-primary-light text-[20px]">mail</span>
              <a href="mailto:bhubaneswarkitchenn@gmail.com" className="hover:text-gold transition-colors">bhubaneswarkitchenn@gmail.com</a>
            </p>
            <p className="flex items-start gap-2">
      ...
      <div className="mt-20 pt-8 border-t border-text-light/10 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
        <p className="font-body-md text-text-light/50">© 2026 BHUBANESWAR KITCHEN & CAFE. All rights reserved. Prop. PRAMOD KUMAR SAHU</p>
